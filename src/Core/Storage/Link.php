...
class Link
{
    ...
    public function save($link)
    {
        ...
        $content .= 'namespace Cpa\TDS\Binary\Link;'.PHP_EOL.PHP_EOL;
        $content .= 'use Cpa\TDS\Core\Handler;'.PHP_EOL;
        $content .= 'use Cpa\TDS\Core\Handler\Result;'.PHP_EOL;
        $content .= 'use Cpa\TDS\Core\Request;'.PHP_EOL;
        $content .= '/**'.PHP_EOL;
